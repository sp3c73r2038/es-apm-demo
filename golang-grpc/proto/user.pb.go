...
func (x *UserFindReq) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x1d, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x46, 0x69, 0x6e, 0x64, 0x52, 0x65,
	0x71, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69,
	0x64, 0x22, 0x3c, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x6d, 0x73, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x2e,
	0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x1f, 0x0a,
	0x08, 0x66, 0x69, 0x6e, 0x64, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0c, 0x2e, 0x55, 0x73, 0x65, 0x72,
	0x46, 0x69, 0x6e, 0x64, 0x52, 0x65, 0x71, 0x1a, 0x05, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x42, 0x14,
	0x5a, 0x12, 0x73, 0x6e, 0x69, 0x70, 0x70, 0x65, 0x74, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x70,
...
var file_proto_user_proto_goTypes = []interface{}{
	(*UserFindReq)(nil), // 0: UserFindReq
	(*User)(nil),        // 1: User
	(*Error)(nil),       // 2: Error
}
var file_proto_user_proto_depIdxs = []int32{
	0, // 0: UserService.findUser:input_type -> UserFindReq
	1, // 1: UserService.findUser:output_type -> User
...
type UserServiceClient interface {
	FindUser(ctx context.Context, in *UserFindReq, opts ...grpc.CallOption) (*User, error)
}
...
func (c *userServiceClient) FindUser(ctx context.Context, in *UserFindReq, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
type UserServiceServer interface {
	FindUser(context.Context, *UserFindReq) (*User, error)
}
...
func (*UnimplementedUserServiceServer) FindUser(context.Context, *UserFindReq) (*User, error) {
...
func _UserService_FindUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).FindUser(ctx, req.(*UserFindReq))
	}
